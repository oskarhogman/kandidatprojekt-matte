\subsection{Polytopes}
	...
	\subsubsection{Proof of equality between $\mathcal{V}$-polytopes and $\mathcal{H}$-polytopes} \label{proofHVequal}
		...
		\begin{proof} 
			...
			: y_k = 0 \}$. This is proven in Lemma \ref{lemma:htovcone}. 
		\end{proof}
		...
		\emph{
		We stated earlier that we can define a $\mathcal{V}$-polytope 
...
\subsection{Ehrhart theory}
	...
	\emph{
		...
		\begin{proof}
			See \cite{beck2020computing} for a complete proof.
		\end{proof}
		...
		\definition{
			...
			\[
				\text{relvol}(F) := \lim_{t \to \infty} \frac{1}{t^{d-1}} 
				|tF \cap \mathbb{Z}^n|.
			\]
		}
