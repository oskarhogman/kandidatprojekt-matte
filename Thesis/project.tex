...
\begin{center}
	\textbf{Abstract}
\end{center}
    Gelfand-Tsetlin patterns play an important role in combinatorics, as they are in bijection with semistandard Young tableaus, a type of Schur function. Using Gelfand-Tsetlin patterns as a number of halfspaces, one can form Gelfand-Tsetlin polytopes. In this thesis, these polytopes are examined up to a dimension of 21 and their Ehrhart polynomials are computed.
...
\end{center}
    Gelfand-Tsetlinmönster spelar en viktig roll i kombinatorik, då de är i bijektion med semistandard Youngtabeller, en typ av Schur-funktion. Genom att använda Gelfand-Tstelinmönster som ett antal halvrum kan man bilda Gelfand-Tsetlinpolytoper. I den här uppsatsen undersöks de här polytoperna upp till en dimension av 21 och deras Ehrhart-polynom beräknas.
