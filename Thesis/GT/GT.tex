\subsection{Gelfand-Tseltin patterns} \label{gtpattern}
		...
		\begin{proof}
			A bijection need to satisfy (1) injection and (2) surjection. 
		...
		\emph{
			That a GT-pattern corresponds to a SSYT means that GT-patterns too are Schur functions, and so the attributes for the Schur functions are also valid for GT-patterns. 
		}
